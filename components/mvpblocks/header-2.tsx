    ...
    <>
      <motion.header
        className={`fixed left-0 right-0 top-0 z-50 transition-all duration-500 ${
          isScrolled ? "border-b border-border/50 bg-background/80 shadow-sm backdrop-blur-md" : "bg-transparent"
        }`}
          ...
          <>
            ...
            >
              <div className="space-y-6 p-6">
                ...
                <motion.div className="space-y-3 border-t border-border pt-6" variants={mobileItemVariants}>
                  <Link
                    href="/login"

...
export default function JournalsPage() {
  const t = useTranslations("JournalPage.comingSoon");
            ...
            <div className="bg-card rounded-lg border p-8 space-y-4 text-left">
              ...
              <div className="space-y-3 text-muted-foreground">
                ...
                <ul className="list-disc list-inside space-y-2 ml-4">
                  ...
                  <li>{t("features.media")}</li>
                  <li>{t("features.chronological")}</li>
                  <li>{t("features.lightweight")}</li>
                  <li>{t("features.markdown")}</li>
                </ul>

...
// https://icon-sets.iconify.design/svg-spinners/?keyword=spi
const spinners = {
	long: (
...
const LoadingSpinner = React.forwardRef<HTMLDivElement, LoadingSpinnerProps>(({ className, type, ...props }, ref) => {
	return (
		<div
			data-testid="spinner"
			className={cn("flex h-4 w-4 animate-spin items-center justify-center text-[color:var(--primary)]", className)}
			ref={ref}
			{...props}
		>
			{spinners[type ?? "long"]}
